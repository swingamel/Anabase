<div class="login-popup">
    <div class="form-popup5" id="popupFormInscription" style="<?= $c->data['displayinc'] ?>">
        <form name="addCongressiste" class="form-container" action="./?controleur=inscription" method="POST">
            <input type="hidden" name="NUM_SESSION" value="<?= $c->post["NUM_SESSION"] ?>">
            <h2>Inscrire un congressiste a une Session</h2>
            </br>
            <div class="container">
                <h1>Vous avez sélectionné la Session n°<?php echo $c->post["NUM_SESSION"] ?></h1>
                <table name="addCongressiste">
                    <tr>
                    ...
                    <?php
                    ?>
                    <?php foreach ($c->data["congressiste"] = $c->modele->getSessionListeCongressiste($c->post["NUM_SESSION"]) as $UnCongressiste) { ?>
                        <tr>
            ...
            <input type="submit" name="todo" value="Inscription" /><br />
            </br>
            <div id="fermer">
